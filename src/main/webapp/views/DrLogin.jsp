	...
	<div class="form-container sign-in-container">
		...
		<c:if test="${drLogFail==0 }">
			...
			<span>use your account</span>
			 <input id="username" name="drUsername"  class='lf--input' placeholder='Username' type='text' required>
			<input name="drPassword" id="password" class='lf--input' placeholder='Password' type='password' required>
