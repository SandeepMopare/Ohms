...
<body class="bg-dark">
	...
	<center>
		<form th:action="@{/}" style="color: white">
			Filter: <input type="text" name="keyword" id="keyword" size="50"
				...
				value="Search" /> <a href='hospitalList' type="button"
				class="btn btn-sm btn-success ml-2">Clear</a>
		</form>
	</center>
	...
	<div class="container mt-3">
		...
		<c:forEach var="hospital" items="${hospitallist}" begin="0" end="100"
			varStatus="srno">
					...
					<div class="row border shadow-lg p-3  bg-light rounded"
						...
						<div class="col-md-4 col-2 ">
							<img style="height: 120px; width: 200px"
								src="image/hospitals/hsp${srno.index+1}.jpg" class="img-fluid"
								alt="...">
						</div>
						...
						<div class="col-8 col-md-6 ">
							...
							<p class="m-0">
								<span class="border bg-success text-light d-inline-block">4.2</span>
